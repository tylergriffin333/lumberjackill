...
class GraphicsProxyRabbyt():
    def __init__(self):
        ...
        os.environ['SDL_VIDEO_WINDOW_POS'] = "%d,%d" % (1280, 750)#2370, 850)#(2080, 1450)#position window
        pygame.init()
        screenSize = self.widthPix, self.heightPix = 400, 300#1366, 768#1680, 1050#TODO: need to get native screen res and set to that.
